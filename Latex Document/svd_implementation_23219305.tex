...
First step is download the MNIST dataset that available at http://yann.lecun.com/exdb/mnist/. There are 4 main file for training data and testing data.
The training data contains $60,000$ examples, and the testing data $10,000$ examples.
Before train the model, we applied SVD as feature extraction to the input images which has 784 total features on each images. 
